...
if (isset($_SESSION['shopit']) || isset($_COOKIE['shopit'])) {
    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button"
         style="background-color:#ff0000;font-size:22px;color:rgb(0,0,0);margin-top: 0;">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav mr-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#works"
                                                                style="color:rgb(0,0,0);">MY UPLOADS</a></li>
                    <!--                            </li>-->                </ul>
            ...
            <form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <div class="form-row profile-row">
                    <div class="col-xs-4 col-md-4">
                        <div class="avatar" style="background:#ff0000">
                            <div data-bs-hover-animate="swing" class="avatar-bg center"
                                 style="background-image:url(../img/intro-carousel/5.jpeg);background-color:#f7f5f5;"></div>
                        </div>
                    ...
                    <div class="col-xs-6 col-md-6" style="">
                        <select class="form-control" name="category"
                            ...
                            <?php
                            $res = $connection->conn->query("SELECT * FROM trucksterscategories");
                            while ($row = $res->fetch(PDO::FETCH_OBJ)) {
                                echo "<option value='$row->id' selected=>".strtoupper($row->name)."</option>";
                        ...
                        <div class="group">
                            <input type="number" step='any' name='price' min="500" value="500" class="form-control"
                                   required>
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>PRICE</label>
                        ...
                        <div class="group">
                            <input type="tel" required class="form-control" name='quantity'>
                            <span class="highlight"></span>
                            <span class="bar"></span>
                        ...
                        <div class="col-xm-4 col-md-6" style="margin: 0 auto;">
                            <button type="submit" class="pulseBtn group btn-block" style="background-color: #ff0000">
                                SUBMIT
                            </button>
                        </div>
                    </div>
    ...
    <section id="works" style="background-image: url('../img/intro-carousel/5.jpeg');>
        <div class="
    ">
                ...
                <div class="pic" style="max-width: 100%;min-height: auto;">
                    <figure>
                        ...
                        <figcaption class="center card-img-overlay">
                            ...
                            <h4 style="color:red;">QUANTITY:<?php echo $rows->quantity; ?></h4>
                    ...
                    <figure>
                        ...
                        <figcaption class="center card-img-overlay">
                            ...
                            <h4 style="color:red;">UPLOADER:<?php
                                $res1 = $connection->conn->query("SELECT * FROM truckstersusers WHERE id=$rows2->uploaderid");
                                while ($row1 = $res1->fetch(PDO::FETCH_OBJ)) {
                                    echo $row1->email;
                                }

                                ?></h4>
                            <h4 style="color:red;">PHONE:<?php echo $rows2->quantity; ?></h4>
                            <h4><a href="<?php echo $_SERVER['PHP_SELF'] ?>?id=<?php echo $rows->id; ?>">DELETE</a></h4>
