...
if (isset($_POST['email']))
    $connection->FarmerLogin($_POST['email'], $_POST['password'], $_POST['remember'], $_SERVER['PHP_SELF']);
...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-button"
     style="background-color:#ff0000;font-size:22px;color:rgb(251,249,249);">
    <div class="container"><a class="navbar-brand" style="color: rgb(0,0,0)" href="#">TRUCKSTERS</a>
        ...
        <div class="collapse navbar-collapse"
            ...
            <span class="navbar-text actions"> <a href="signup.php" class="login" style="color:rgb(0,0,0);">SIGN UP</a>
                       </span></div>
    </div>
    </div>
</nav>
...
<div class="login-clean" style="background-color:rgb(255,255,255);">
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <div data-bs-hover-animate="swing" class="illustration" style="width:257px;height:183px;"><i
                    class="icon ion-ios-navigate" data-bs-hover-animate="bounce" style="color:#ff0000;"></i>
        </div>
        ...
        <div class="form-group">
            <button class="btn btn-primary btn-block" type="submit" data-bs-hover-animate="rubberBand"
                    style="background-color:#ff0000;">Log In
            </button>
        </div>
