    ...
    <section id="posts" class="section-bg">
        <div class="container">
            ...
            <div class="row portfolio-container">
                ...
                <?php
                $sq = "SELECT * FROM trucksterscategories WHERE name=?";
                ...
                while (@$rows2 = $resu->fetch(PDO::FETCH_OBJ)) {
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app wow  ">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo 'post/' . $rows2->pic ?>" height="100%" class="img-fluid" alt="">
                                <a href="<?php echo 'post/' . $rows2->pic ?>"  height="100%" data-lightbox="portfolio"
